...
<div class="video-wrap" id="a1"></div>
...
<div class="video-menu">
    <div class="video-button clearfix">
        <span class="fl" onclick="go()">上一集</span>
        <span class="fr">下一集</span>
    </div>
...
<div class="video-content clearfix">
    ...
    <p>
        互联网为企业整合营销资源，探索、创造和传递价值，实现消费者价值体验，打开了全新营销思路；为消费者搜索和传递各种资讯，彰显个人需求，实现与企业共同创造价值，提供了全新方法。本课程为您讲述互联网营销的新思路和新方法，带您领略网络创意营销的神奇。</p>
</div>
