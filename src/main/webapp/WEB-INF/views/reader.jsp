        ...
        $.ready(function () {
            ...
            var createFragment = function (ul, index, count, reverse) {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    li.innerHTML = "<img class=\"readerPic\" src=\"" + autoReplaceImage(obj[i].image, "/static/image/listen.png") + "\" /><p class=\"title word\">" + obj[i].name + "</p><p class=\"author word\">共" + obj[i].count + "集</p>";
